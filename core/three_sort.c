...
/*   Updated: 2026/01/15 11:11:50 by stmaire          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	three_sort(t_stack_node **stack_a)
{
	...
	if (node_one->index > node_two->index && node_one->index > node_three->index)
		ra(stack_a);
	else if (node_two->index > node_one->index && node_two->index > node_three->index)
		rra(stack_a);
